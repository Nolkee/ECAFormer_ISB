...
CONFIGS=(
  "Options/ISB_ecaformer_full_s19_r17a_r6c_grayillu_no_outnorm_clampedloss.yml"
  "Options/ISB_ecaformer_full_s19_r17b_r6c_grayillu_no_outnorm_trainclamp.yml"
  "Options/ISB_ecaformer_full_s19_r17c_r6c_grayillu_no_outnorm_hardtanh.yml"
)
